...
class ProjectMapper(Mapper):
    ...
    def find_all(self):
        ...
        cursor.execute("SELECT id, owner from projects")
    ...
    def find_by_owner_id(self, owner_id):
        ...
        result = []
        cursor = self._cnx.cursor()
        command = "SELECT id, owner FROM projects WHERE owner={} ORDER BY id".format(owner_id)
    ...
    def find_by_key(self, key):
        ...
        cursor = self._cnx.cursor()
        command = "SELECT id, owner FROM projects WHERE id={}".format(key)
        cursor.execute(command)
        tuples = cursor.fetchall()
